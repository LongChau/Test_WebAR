...
public static class EnumExtensions
{
    ...
    /// <summary>
    /// Flag compare. These enum must use System.[Flags] tag
    /// </summary>
    /// <param name="enumA">First enum</param>
    /// <param name="enumB">Second enum</param>
    /// <returns></returns>
    public static bool IsContainFlag(this Enum enumA, Enum enumB)
    {
        int valueA = enumA.To<int>();
        int valueB = enumB.To<int>();


        return ((valueA & valueB) != 0);    // true: YES, false: NO
    }
    #endregion
}